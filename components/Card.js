        ...
        <View>
          <View style={[this.props.style, {alignSelf: 'center'}]}>
            <View style={[{backgroundColor: 'rgba(0,0,0,0)'}]}>
              ...
              <View style={{width: window.width * (this.props.full ? 0.98 : 0.8), height: (window.width * 0.24), borderBottomLeftRadius: 4, borderBottomRightRadius: 4, backgroundColor: 'rgba(240,240,240, 1)', paddingLeft: 22, top: -3, flex: 1, flexDirection: 'row'}}>
                <View style={{flex: 4}}>
                  ...
                  <Text style={{color: 'rgba(0, 203, 255, 1)', marginTop: 3, fontSize: 14, fontWeight: 'bold', bottom: 5, position: 'absolute'}}>Rs. 64,990</Text>
                </View>
                <View style={{flex: 0, marginTop: 40, right: 40, opacity: (this.props.full ? 1 : 0)}}>
                  <TouchableOpacity onPress={() => console.info('Yo')} style={{borderWidth: 2, borderRadius: 15, borderColor: 'rgba(80, 227, 194, 1)'}}>
                    <Text style={{ paddingLeft: 12, paddingRight: 12, paddingBottom: 3, textAlign:'center', color: 'rgba(80, 227, 194, 1)', fontSize: 16, backgroundColor: 'rgba(0, 0, 0, 0)'}}>Buy</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
