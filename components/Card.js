        ...
        <View>
          <View style={[this.props.style, {alignSelf: 'center'}]}>
            <View style={[{backgroundColor: 'rgba(0,0,0,0)'}]}>
              ...
              <View style={{width: window.width * (this.props.full ? 0.98 : 0.8), height: ((window.height * 0.6) - (window.width * 0.8)), borderBottomLeftRadius: 4, borderBottomRightRadius: 4, backgroundColor: 'rgba(240,240,240, 1)', paddingLeft: 22, top: -3}}>
